		...
		<script type="text/javascript">
			function showDetail(oid){
				...
				if(but.value == "订单详情"){
					...
					// 3.打开连接
					xhr.open("GET","${pageContext.request.contextPath}/queryOrderItemByOid.do?oid="+oid+"&time="+new Date().getTime(),true);
					// 4.发送
					xhr.send(null);
					but.value = "关闭";
				}else{
									...
									<c:forEach items="${orderList}" var="o">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td style="CURSOR: hand; HEIGHT: 22px" align="center"
												...
												<c:if test="${o.state==2}">
													<a href="${pageContext.request.contextPath }/updateAdminOrderState.do?oid=${o.oid}"><font color="blue">发货</font></a>
												</c:if>
												<c:if test="${o.state==3}">
													等待确认收货
												</c:if>
