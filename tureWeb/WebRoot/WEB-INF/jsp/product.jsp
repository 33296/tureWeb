		...
		<div class="span6">
			<div class="hotProductCategory">
				<c:forEach items="${cList}" var="c">
						<dl>
							<dt>
								<a href="${ pageContext.request.contextPath }/findProductByCid.do?cid=${c.cid }&page=1">${c.cname }</a>
							</dt>
							
							<c:forEach items="${csList }" var="cs">
								<c:if test="${cs.cid == c.cid }">
									<dd>
										<a href="${ pageContext.request.contextPath }/_findProductByCsid.do?csid=${cs.csid }&page=1">${cs.csname }</a>
									</dd>
								</c:if>
							</c:forEach>
						</dl>
		...
		<div class="span18 last">
			...
			<div class="info">
				<dl>
					<dt>商城价:</dt>
					<dd>
						<strong>￥：${p.shop_price }元</strong>
							参 考 价：
							<del>￥${p.market_price }元</del>
					</dd>
				</dl>
					<dl>
						<dt>促销:</dt>
				...
				<div class="action">
						<dl class="quantity">
							...
							<dd>
								...
								<div>
									<span id="up" class="increase" onclick="up()"></span>
									<span id="dow" class="decrease" onclick="dow()"></span>
								</div>
							</dd>
							<dd>
								件
